...
public class NewBooks extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference nm = FirebaseDatabase.getInstance().getReference("NewBook");
        nm.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    rv.setAdapter(new Myadapter2(listData, new rvonclickinterface() {
                        @Override
                        public void onclick(int position) {
                            ...
                            Intent i=new Intent(NewBooks.this,BookActivity.class);
    ...
    private void search(String newText) {
        ...
        rv.setAdapter(new Myadapter2(mylist, new rvonclickinterface() {
            @Override
            public void onclick(int position) {
