...
public class Myadapter2 extends RecyclerView.Adapter<Myadapter2.ViewHolder>  {
    ...
    public Myadapter2(List<Book> listData, rvonclickinterface clickinterface) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.newcardholder,parent,false);
